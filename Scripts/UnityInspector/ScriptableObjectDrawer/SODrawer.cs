...
public class ScriptableObjectDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty serializedProperty, GUIContent label)
    {
        ...
        DrawScriptableObjectContents(position, serializedProperty, label);
    }
    ...
    public override float GetPropertyHeight(SerializedProperty serializedProperty, GUIContent label)
    {
        ...
        {
            SerializedProperty fieldProperty = serializedObject.FindProperty(field.Name);
            if(fieldProperty == null) return EditorGUIUtility.standardVerticalSpacing;
